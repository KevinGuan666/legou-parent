package com.kkb.legou.core.controller;
...
import com.kkb.legou.core.utils.GenericUtil;
...
public abstract class BaseController<S extends ICrudService<T>, T extends BaseEntity> {
    ...
    @PostMapping("/save")
    public ResponseBean save(@RequestBody T entity) throws Exception {
