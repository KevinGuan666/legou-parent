package com.kkb.legou.common.utils;
...
public class DateUtil {
    ...
    /***
     * 从yyyy-MM-dd HH:mm格式转成yyyyMMddHH格式 * @param dateStr
     * @return
     */
    ...
    /***
     * 获取时间菜单 * @return */
    public static List<Date> getDateMenus(){ //定义一个List<Date>集合，存储所有时间段
        List<Date> dates = getDates(12); //判断当前时间属于哪个时间范围
        Date now = new Date();
    ...
    /***
     * 指定时间往后N个时间间隔 * @param hours
     * @return
     */
    public static List<Date> getDates(int hours) {
        List<Date> dates = new ArrayList<Date>(); //循环12次
    ...
    public static void main(String[] args) {
        getDates(12).forEach(t -> System.out.println(t));
        System.out.println("--------------");
